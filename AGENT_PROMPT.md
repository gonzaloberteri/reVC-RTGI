...
6. **Interior light shafts: UNBLOCKED - coords catalogued from IPLs.** Interior placements live in data/maps/**/*.ipl (text; inst rows: id,model,INTERIOR,x,y,z) - parse offline, no game runs. VERIFIED: mall area=4 tp=414,1114,20 (food court, skylights above - prime light-shaft target), malibu area=17 tp=484,-68,12 (dance floor). Hotel area=1 = save start. Biker bar area=11 tp=-418,75,13 BAD (hospital respawn - nudge z, try 14.5). Full table: bank 3 (-934,-338,15), strip club 5 (85,-1456,11), lawyers 6 (145,-1376,12), coffee shop 7 (-1170,-618,12), concert hall 8 (-927,1059,13), police 12 (346,-445,13), print works 18 (-1073,-280,12). NEXT: volumetric shafts from the mall skylights.
